...
- [ ] App handles edge cases: no tasks/notes/events, very long titles, no internet for transcription
- [ ] Final integration test: create task from calendar, complete task cancels notification, record voice note and play back, create event and receive reminder
- [ ] App builds successfully as APK via EAS Build local
